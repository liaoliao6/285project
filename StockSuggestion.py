...
stocks = {
    'Ethical Investing': ["AAPL", "FB", "ADBE", "GOOGL", "MSFT"],
    'Growth Investing': ["PYPL", "NVDA", "AMD", "TSLA"],
    'Index Investing': ["VOO", "VTI", "ILTB", "SOXX", "SPY"],
    'Quality Investing': ["AMZN", "MU", "CSCO", "V", "AAL"],
    'Value Investing': ["INTC", "TTGT", "GE", "HD", "DIS"]
}
...
def suggest_stocks(amount, strategies):
